...
import { approveReturnBorrrowBook } from '../fn/book/approve-return-borrrow-book';
import { ApproveReturnBorrrowBook$Params } from '../fn/book/approve-return-borrrow-book';
...
import { returnBorrrowBook } from '../fn/book/return-borrrow-book';
import { ReturnBorrrowBook$Params } from '../fn/book/return-borrrow-book';
...
import { updateSharebleStatus } from '../fn/book/update-shareble-status';
import { UpdateSharebleStatus$Params } from '../fn/book/update-shareble-status';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `updateSharebleStatus()` */
  static readonly UpdateSharebleStatusPath = '/books/shareable/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `updateSharebleStatus()` instead.
   *
   * This method doesn't expect any request body.
   */
  updateSharebleStatus$Response(params: UpdateSharebleStatus$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return updateSharebleStatus(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `updateSharebleStatus$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  updateSharebleStatus(params: UpdateSharebleStatus$Params, context?: HttpContext): Observable<number> {
    return this.updateSharebleStatus$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }

  /** Path part for operation `returnBorrrowBook()` */
  static readonly ReturnBorrrowBookPath = '/books/borrow/return/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `returnBorrrowBook()` instead.
   *
   * This method doesn't expect any request body.
   */
  returnBorrrowBook$Response(params: ReturnBorrrowBook$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return returnBorrrowBook(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `returnBorrrowBook$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  returnBorrrowBook(params: ReturnBorrrowBook$Params, context?: HttpContext): Observable<number> {
    return this.returnBorrrowBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }

  /** Path part for operation `approveReturnBorrrowBook()` */
  static readonly ApproveReturnBorrrowBookPath = '/books/borrow/return/approve/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `approveReturnBorrrowBook()` instead.
   *
   * This method doesn't expect any request body.
   */
  approveReturnBorrrowBook$Response(params: ApproveReturnBorrrowBook$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return approveReturnBorrrowBook(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `approveReturnBorrrowBook$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  approveReturnBorrrowBook(params: ApproveReturnBorrrowBook$Params, context?: HttpContext): Observable<number> {
    return this.approveReturnBorrrowBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
