...
public class BookController {
    ...
    public ResponseEntity<Integer> updateSharebleStatus(@PathVariable("book-id") Integer bookId, Authentication connectedUser){
    ...
    public ResponseEntity<Integer> returnBorrrowBook(@PathVariable("book-id") Integer bookId, Authentication connectedUser){
        return ResponseEntity.ok(bookService.returnBorrowedBook(bookId,connectedUser));
    }

    @PatchMapping("/borrow/return/approve/{book-id}")
    public ResponseEntity<Integer> approveReturnBorrrowBook(@PathVariable("book-id") Integer bookId, Authentication connectedUser){
