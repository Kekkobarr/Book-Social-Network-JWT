package com.kekkobarr.booksocialnetwork.feedback;

import com.kekkobarr.booksocialnetwork.book.Book;
import com.kekkobarr.booksocialnetwork.book.BookRepository;
...
public class FeedbackService {
    ...
    public PageResponse<FeedbackResponse> findAllFeedbacksByBook(Integer bookId, int page, int size, Authentication connectedUser) {
        ...
        User user = ((User) connectedUser.getPrincipal());
        Page<Feedback> feedbacks = feedbackRepository.findAllByBookdId(bookId, pageable);
